...
### Changed
- Renamed `PROXY_PORT` environment variable to `WS_PORT`
- Renamed Prometheus metrics prefix from `hlnode_proxy_` to `hlnode_ws_`
- Updated README for WebSocket-only documentation
- GitHub releases now created as drafts (private)
- Docker image renamed to `imperatorco/hlnode-websocket`
